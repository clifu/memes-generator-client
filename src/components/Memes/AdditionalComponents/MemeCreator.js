        ...
        return (
            <div className="page-wrap">
                <div className="controls">
                    ...
                    <input className="controls__input" id="name" type="text" value={this.state.topTextOnImage} onChange={this.handleTopChange}/>
                </div>
                <div id="canvas-wrap">
                    <canvas style={{display: 'block', width: '400px', height: '400px'}} id="imageCanvas">
                        <canvas id="canvasID"></canvas>
                    </canvas>
                </div>
                <button className='btn' id="download" type='button'>Zapisz sobie memesa</button>
            </div>
       );
    }
}
